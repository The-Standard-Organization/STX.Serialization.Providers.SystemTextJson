...
namespace STX.Serialization.Providers.SystemTextJson.Infrastructure.Build.Services
{
                ...
                Jobs = new Dictionary<string, Job>
                {
                    ...
                    },
                    {
                        ...
                        new TagJob(
                            runsOn: BuildMachines.UbuntuLatest,
                            dependsOn: "build",
                            projectRelativePath: "STX.Serialization.Providers.SystemTextJson/" +
                                "STX.Serialization.Providers.SystemTextJson.csproj",
